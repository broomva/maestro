...
- **Work detail / inspector** — `WorkDetail.jsx`. One object, three projections: lifecycle rail (proposed → reviewing → triggered → running → review → done), activity timeline (receipts), chat. Approve / Send back are the only gate controls.
